...
// 		errtext << "file \'" << ex->get_streamName().c_str() << "\' near line ";
	}
...
// 	errtext << this->get_rec()->get_state()->get_exception()->get_line() << ": ";
	...
	errtext << this->get_rec()->get_state()->get_exception()->get_message();
...
// 											? "<no text for the token>" : ttext ) << "\n";
            errtext << " " << (ttext.empty() ? "<no text for the token>" : ttext);
		}
	}
    errtext << "; error near line " << this->get_rec()->get_state()->get_exception()->get_line();
